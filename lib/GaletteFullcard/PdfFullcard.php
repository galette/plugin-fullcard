...
class PdfFullcard extends Pdf
{
    ...
    private function init()
    {
        ...
        $this->SetTitle(_T("Member's full card"));
     ...
     * Draw member cards
     *
     * @param Adherent $member Member or null
     *
     * @return void
     */
    public function drawCard(Adherent $member = null)
    {
        ...
        $this->SetFont(Pdf::FONT, '', FULLCARD_FONT);
        $this->SetX(100);
        $this->MultiCell(0, 4, $this->preferences->getPostalAddress(), 0, 'L');
        $this->Ln(3);
        $this->Line($this->GetX(), $this->GetY(), 200, $this->GetY());
        ...
        if ($member !== null) {
            $this->Cell(0, 7, $member->adress, 0, 1, 'L');
        }
        $this->Line($this->GetX()+30, $this->GetY()-1, 190, $this->GetY()-1);
        $this->SetY($this->GetY() + 7);
        if ($member !== null) {
            $this->Cell(0, 7, $member->adress_continuation, 0, 1, 'L');
        }
        $this->Line($this->GetX()+30, $this->GetY()-1, 190, $this->GetY()-1);
        $this->SetY($this->GetY() + 7);
        $this->Line($this->GetX()+30, $this->GetY()-1, 190, $this->GetY()-1);
        ...
        $this->Cell(30, 7, _T("Email adress"), 0, (($member === null)?1:0), 'L');
        if ($member !== null) {
        ...
        $this->Ln(10);
        $this->Cell(64, 5, _T("At "), 0, 0, 'L');
        $this->Cell(0, 5, _T("On            /            /            "), 0, 1, 'L');
        $this->Ln(1);
